...
- [x] **Other ADRs / decision docs** — Storybook ADR-021 reorganized the then-live spec/build-map pair into category structure with `spec:N.N` IDs (Story 148). C7 constraint block is now at `spec:5.1`.
