...
Use `docs/methodology/graph.json`, `docs/methodology/state.yaml`, and `/triage` output for current sequencing. Story `205` now stands as the completed bounded proof for the first `mixed-archive` ZIP seam, Story `223` is the bounded PDF-member approved-handoff continuation on that same route/module line across the checked-in ZIP and direct-folder probes, Story `222` is the direct-folder PDF-member recommendation substrate underneath that proof, and Story `218` remains the original non-PDF direct-folder proof; use them as evidence for the specific checked-in fixtures and emitted member-route artifacts, not as blanket archive-support claims. Story `208` closed the bounded stronger-OCR benchmark line for the handwritten blocker with negative evidence, so Story `191` remains blocked until a later pass proves a materially stronger OCR substrate. Historical Fighting Fantasy/gamebook stories remain in the index below as project record and reference evidence, not as the default mission queue.

## Active Focus

- Campaign `maintained-intake-honesty` (active; stories: 191, 196, 197, 200, 201, 202, 203, 205, 208, 218, 221, 222, 223) — Recent bounded proof and direct-entry expansions are done; Story 205 closed the first ZIP-only mixed-archive routing seam as bounded maintained evidence, Story 218 widened that same seam to one checked-in source-native folder probe, Story 221 established the ZIP PDF-member recommendation substrate, Story 222 added the direct-folder PDF-member recommendation substrate, Story 223 extended the approved-handoff proof to one checked-in ZIP PDF-member slice plus one checked-in direct-folder PDF-member slice, and Story 208 closed the bounded stronger-OCR benchmark line for the handwritten blocker with negative evidence. Keep Story 191 blocked until a later pass produces fresh current-pass evidence for a materially stronger OCR substrate, and treat Stories 205, 218, 222, and 223 as proof for one ZIP direct-entry mix, one source-native folder mix, one direct-folder recommendation substrate, and one approved-handoff slice on each bounded PDF-member entry surface rather than broad archive or folder ownership.
...
| 223 | Expand the First Honest PDF-Member Approved-Handoff Seam to Direct-Folder Parity | High | Done | 176, 180, 196, 205, 221, 222 | [story-223](stories/story-223-mixed-archive-pdf-member-approved-handoff-seam.md) |
